...
const routes = [
  ...
  {
    path: '/:empresa/admin/solicitacoes',
    name: 'admin.solicitacoes',
    component: () => import('@/views/admin/SolicitacoesView.vue'),
    props: true,
    meta: { contexto: 'admin', exigeAutenticacao: true, exigeSenhaDefinitiva: true },
  },
  {
  ...
  {
    path: '/:empresa/registros',
    name: 'registros',
    component: () => import('@/views/MeusRegistrosView.vue'),
    props: true,
    meta: { contexto: 'funcionario', exigeAutenticacao: true, exigeSenhaDefinitiva: true },
  },
  {
    path: '/:empresa/solicitacoes',
    name: 'solicitacoes',
